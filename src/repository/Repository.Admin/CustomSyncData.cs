...
public class CustomSyncData : SyncData, ISyncData
{
	...
	/// <param name="dbConfig"></param>
	/// <returns></returns>
	private async Task InitUserAsync(IFreeSql db, IRepositoryUnitOfWork unitOfWork, DbConfig dbConfig)
	{
	...
	/// <param name="dbConfig"></param>
	/// <returns></returns>
	private async Task InitRoleAsync(IFreeSql db, IRepositoryUnitOfWork unitOfWork, DbConfig dbConfig)
	{
