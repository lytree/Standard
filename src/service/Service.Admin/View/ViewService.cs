...
using Service.Admin.View.Dto;

namespace Service.Admin.View;
...
public class ViewService : BaseService, IViewService, IDynamicApi
{
    ...
    public virtual async Task SyncAsync(ViewSyncInput input)
    {
        ...
        //批量更新
        {
            ...
            //禁用
            var disabledViews = (from a in views where (a.Path != null || a.Name != null) && (!inputPaths.Contains(a.Path) || !inputNames.Contains(a.Name)) select a).ToList();
